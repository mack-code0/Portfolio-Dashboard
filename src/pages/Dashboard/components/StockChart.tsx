...
const InteractiveChart = () => {
  ...
  return (<>
    <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:items-center justify-between mb-3">
      <h1 className="text-[18px] text-primText font-[500]">Balance</h1>

      <div className="flex border border-[#66666660] rounded-[6px] overflow-hidden w-fit">
        {[
          "1D",
          "1W",
          "1M",
    ...
    <div className="w-full overflow-x-scroll no-scrollbar">
      <div className="h-[250px] w-[900px] sm:w-full">
