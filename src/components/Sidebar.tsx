...
const Sidebar: React.FC<{ sidebarOpen: boolean, toggleSidebar: () => void }> = ({ sidebarOpen, toggleSidebar }) => {
    ...
    return (<>
        ...
        <div className={`${!sidebarOpen && "left-[-300px] xl:left-0"} w-[300px] h-screen bg-primBg border-r border-secBg overflow-x-hidden overflow-y-scroll no-scrollbar fixed xl:relative z-10`}>
